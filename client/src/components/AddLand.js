...
const AddLand = () => {
  ...
  const [ready_1, setReady_1] = useState('upload Doc')
  const [ready_2, setReady_2] = useState('upload support doc')
  const [ready_3, setReady_3] = useState('upload Land Image')
  ...
  return (
    <form onSubmit={submitForm}>
      ...
      <label>{ready_3}:
          <input type="file" name="" id="" required onChange={(e)=>onSubmitImg(e)} />
        </label><br />
      <label>{ready_1}:
